...
/*
* Destruye un pokemon (función para la lista_con_cada_elemento)
...
* Post: Memoria reservada para un entrenador liberada
*/
...
/*
* Destruye un gimnasio (función para heap_crear)
...
/*
* Condición para el heap de gimnasios
...
* Post: Verdadero si tiene al menos un entrenador y este tiene pokemones (y una cantidad menor al máximo)
*/
...
/*
* Devuelve un booleano que indica si el gimnasio debe estar en el conjunto (heap)
* Pre : Gimnasio creado y leido
...
/* 
* Dada una clave, evalua si coincide con alguna de las claves válidas
...
/* 
* Crea un pokemon el heap, inicializandolo con lo que lee de la línea
...
/* 
* Dado un archivo, crea un personaje según la linea actual
...
/* 
* Dado un archivo, crea un entrenador según la linea actual
...
/* 
* Dado un archivo, lee un pokemon agregandolo a las listas del personaje según corresponda
...
* Pre : Archivo abierto y pila de gimnasios creado, clave leida e igual a CLAVE_GIMNASIO
...
/**************   FUNCIONES PRINCIPALES DE LA LECTURA   ****************/

/*
* Transpasa los gimnasios de una pila a un heap
* Pre :  Pila de gimnasios creada y no vacia
* Post: Heap creado con gimnasios (o NULL en caso de error) y Pila destruida
*/
...
* Pre : Archivo abierto para lectura
* Un solo personaje con al menos un pokemon
